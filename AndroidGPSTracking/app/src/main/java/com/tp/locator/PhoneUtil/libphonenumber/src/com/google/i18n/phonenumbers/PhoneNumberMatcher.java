...
package com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers;

import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.Leniency;
import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.MatchType;
import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.PhoneNumberFormat;
import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.Phonemetadata.NumberFormat;
import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.Phonemetadata.PhoneMetadata;
import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.Phonenumber.PhoneNumber;
import com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.Phonenumber.PhoneNumber.CountryCodeSource;
...
final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
  ...
  static {
     ...
     * country code. */
    int digitBlockLimit =
            com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_FOR_NSN + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_COUNTRY_CODE;
    ...
    String punctuation = "[" + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.VALID_PUNCTUATION + "]" + punctuationLimit;
    /* A digits block without punctuation. */
    String digitSequence = "\\p{Nd}" + limit(1, digitBlockLimit);

    String leadClassChars = openingParens + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS;
    ...
    PATTERN = Pattern.compile(
        ...
        "(?:" + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERNS_FOR_MATCHING + ")?",
            com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.REGEX_FLAGS);
  }
  ...
  private final com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil phoneUtil;
   ...
   */
  PhoneNumberMatcher(com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util, CharSequence text, String country, Leniency leniency,
      long maxTries) {
  ...
  private PhoneNumberMatch find(int index) {
    ...
    while ((maxTries > 0) && matcher.find(index)) {
      ...
      candidate = trimAfterFirstMatch(com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.SECOND_NUMBER_START_PATTERN, candidate);
      ...
      while (groupMatcher.find() && maxTries > 0) {
        if (isFirstMatch) {
          ...
          CharSequence group = trimAfterFirstMatch(
                  com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.UNWANTED_END_CHAR_PATTERN,
        ...
        CharSequence group = trimAfterFirstMatch(
                com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.UNWANTED_END_CHAR_PATTERN, groupMatcher.group(1));
  ...
  interface NumberGroupingChecker {
     ...
     */
    boolean checkGroups(com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util, PhoneNumber number,
                        StringBuilder normalizedCandidate, String[] expectedNumberGroups);
  }

  static boolean allNumberGroupsRemainGrouped(com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util,
                                              PhoneNumber number,
  ...
  static boolean allNumberGroupsAreExactlyPresent(com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util,
                                                  PhoneNumber number,
                                                  StringBuilder normalizedCandidate,
                                                  String[] formattedNumberGroups) {
    String[] candidateGroups =
            com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.NON_DIGITS_PATTERN.split(normalizedCandidate.toString());
   ...
   */
  private static String[] getNationalNumberGroups(com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util, PhoneNumber number,
  ...
  static boolean checkNumberGroupingIsValid(
      PhoneNumber number, String candidate, com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util, NumberGroupingChecker checker) {
    // TODO: Evaluate how this works for other locales (testing has been limited to NANPA regions)
    // and optimise if necessary.
    StringBuilder normalizedCandidate =
            com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.normalizeDigits(candidate, true /* keep non-digits */);
  ...
  static boolean containsMoreThanOneSlashInNationalNumber(PhoneNumber number, String candidate) {
    ...
    if (candidateHasCountryCode &&
            com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(candidate.substring(0, firstSlashInBodyIndex))
  ...
  static boolean containsOnlyValidXChars(
      PhoneNumber number, String candidate, com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util) {
    ...
    for (int index = 0; index < candidate.length() - 1; index++) {
      ...
      if (charAtIndex == 'x' || charAtIndex == 'X') {
        ...
        // extension number.
        } else if (!com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(candidate.substring(index)).equals(
            number.getExtension())) {
          return false;
        }
      }
  ...
  static boolean isNationalPrefixPresentIfRequired(PhoneNumber number, com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil util) {
    ...
    if ((formatRule != null) && formatRule.getNationalPrefixFormattingRule().length() > 0) {
      ...
      if (com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.formattingRuleHasFirstGroupOnly(
              formatRule.getNationalPrefixFormattingRule())) {
        // National Prefix not needed for this number.
        return true;
      }
      // Normalize the remainder.
      String rawInputCopy = com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(number.getRawInput());
