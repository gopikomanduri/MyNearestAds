...
public class AsYouTypeFormatter {
  ...
  private final com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil phoneUtil = com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.getInstance();
  ...
  private static final Pattern ELIGIBLE_FORMAT_PATTERN =
      Pattern.compile("[" + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.VALID_PUNCTUATION + "]*" +
          "(\\$\\d" + "[" + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.VALID_PUNCTUATION + "]*)+");
  ...
  private com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.RegexCache regexCache = new com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.RegexCache(64);
    ...
    for (NumberFormat format : formatList) {
      if (!nationalPrefixIsUsedByCountry || isCompleteNumber ||
          format.isNationalPrefixOptionalWhenFormatting() ||
              com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.formattingRuleHasFirstGroupOnly(
  ...
  private boolean isDigitOrLeadingPlusSign(char nextChar) {
    return Character.isDigit(nextChar) ||
        (accruedInput.length() == 1 &&
                com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS_PATTERN.matcher(Character.toString(nextChar)).matches());
  }
  ...
  private boolean attemptToExtractIdd() {
    Pattern internationalPrefix =
        regexCache.getPatternForRegex("\\" + com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN + "|" +
    ...
    if (iddMatcher.lookingAt()) {
      ...
      if (accruedInputWithoutFormatting.charAt(0) != com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN) {
        prefixBeforeNationalNumber.append(SEPARATOR_BEFORE_NATIONAL_NUMBER);
      }
      return true;
    }
  ...
  private boolean attemptToExtractCountryCallingCode() {
    ...
    if (com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY.equals(newRegionCode)) {
  ...
  private char normalizeAndAccrueDigitsAndPlusSign(char nextChar, boolean rememberPosition) {
    char normalizedChar;
    if (nextChar == com.tp.locator.PhoneUtil.libphonenumber.src.com.google.i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN) {
